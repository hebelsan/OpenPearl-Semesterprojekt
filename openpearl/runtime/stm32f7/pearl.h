...
#define configUSE_STATIC_STACK_AND_TCB	1
#define configUSE_TASK_AUTORESTART	1
...
#define INCLUDE_vTaskSetAutoRestart	1
...
#define INCLUDE_xTaskGetCurrentFreeStack	1
...
#define STM32F7XX_CLOCK_INCLUDED
namespace pearlrt {

   class Stm32f7xxClock {
   private:
   public:

      Stm32f7xxClock(const int typeOfClock);
   };
}
